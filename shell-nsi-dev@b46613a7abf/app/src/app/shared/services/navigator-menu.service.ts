...
import { GasMenuService, GasHeaderService, GasMenu, GasIcon, GasBreadcrumb } from '@cikrf/gas-ui-kit';
...
export class NavigatorMenuService {
  ...
  public constructor(
    ...
    this.routerEvent$?.subscribe((event: any) => {
      ...
      if (eventUrlAfterRedirect !== NavigatorMenuService.ERROR_URL) {
        ...
        const isActiveRouteInitial = this.gasMenuService.activeRoute === NavigatorMenuService.INITIAL_URL;
  ...
  private addRouteToBreadcrumbsIfCorrect(route: ActivatedRouteSnapshot, breadcrumbs: GasBreadcrumb[]) {
