...
@UntilDestroy()
@Component({
  selector: 'app-base-header-actions',
  templateUrl: './base-header-actions.component.html',
  styleUrls: ['./base-header-actions.component.scss'],
})
export class BaseHeaderActionsComponent {
  @NgAfterViewInit()
