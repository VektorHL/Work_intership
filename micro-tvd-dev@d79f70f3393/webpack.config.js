...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      '@apptypes': path.resolve(__dirname, 'src/app/apptypes/'),
      '@config': path.resolve(__dirname, 'src/app/configuration/'),
    },
  },
  plugins: [
    new ModuleFederationPlugin({
      ...
      remotes: {
        auth: 'auth@https://auth.platform.apps.dev.devsun.ru/remoteEntry.js',
      },
      exposes: {
        './Module': './src/app/mfe.module.ts',
        './ToolbarConfig': './src/app/configuration/toolbar-buttons',
      },
      shared: share({
